...
import (
	...
	"github.com/d-ishizuka/get_it_done/restapi/operations"
)

//go:generate swagger generate server --target ../../get_it_done --name GetIDDoneAPI --spec ../api/swagger/swagger.yaml --principal interface{}

func configureFlags(api *operations.GetIDDoneAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GetIDDoneAPIAPI) http.Handler {
	...
	if api.UpdateTodoHandler == nil {
		api.UpdateTodoHandler = operations.UpdateTodoHandlerFunc(func(params operations.UpdateTodoParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.UpdateTodo has not yet been implemented")
		})
	}
